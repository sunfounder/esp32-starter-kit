...
さらに、プロジェクトは単一の3.7V 18650バッテリーで電源を供給することができます。バッテリーの残量が少なくなった場合は、5VのUSBケーブルを接続するだけで充電することができます。これにより、屋外プロジェクトやリモートアプリケーションに最適なツールとなります。
...
* **充電ポート**
    * 5Vの USBケーブルを接続すると、バッテリーを充電できます。
...
* **インジケーターライト**
    * **PWR**: バッテリーが電源供給されているか、USBがESP32に直接接続されているときに点灯します。
    * **CHG**: USBをボードの充電ポートに接続すると点灯し、充電が開始されたことを示します。バッテリーが完全に充電されると、消灯します。
...
**バッテリーの電源と充電**
    ...
    バッテリーが消耗している場合、5VのUSBを接続して充電します。
