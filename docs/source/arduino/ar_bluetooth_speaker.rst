...
#. Open the code.
    ...
    * Open the ``6.8_bluetooth_speaker.ino`` file under the path of ``esp32-ultimate-kit\c\codes\6.8_bluetooth_speaker``.
    * Or copy this code into **Arduino IDE**.
    * The ``ESP32-A2DP`` library is used here, refer to :ref:`install_libraries_ar` for a tutorial to install.

    .. raw:: html

#. After selecting the correct board and port, click on the Upload button.

    .. image:: img/upload_bluetooth.png
