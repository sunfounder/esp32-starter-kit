...
Im Gegensatz zum **Stage**-Modus muss der Code im **Upload**-Modus auf das ESP32-Platine hochgeladen werden, um den Effekt zu sehen, indem Sie den Button **Upload Code** verwenden. So können Sie auch das USB-Kabel abziehen und das Programm weiterlaufen lassen.
