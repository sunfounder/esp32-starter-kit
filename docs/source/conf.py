...
.. |link_processing_download| raw:: html
    ...
    <a href="https://processing.org/download" target="_blank">Procesing scaricare</a>

.. |link_processing_tutorial| raw:: html

    <a href="https://processing.org/tutorials/overview/" target="_blank">Processing Panoramica</a>
...
.. |link_blynk_quickstart| raw:: html
    ...
    <a href="https://docs.blynk.io/en/getting-started/what-do-i-need-to-blynk/quickstart-device-code-overview" target="_blank">Blynk Avvio rapido</a> 

.. |link_blynk_doc| raw:: html

    <a href="https://docs.blynk.io/" target="_blank">Blynk Documentazione</a> 

.. |link_blynk_syncing| raw:: html

    <a href="https://docs.blynk.io/en/blynk-library-firmware-api/state-syncing#for-hardware" target="_blank">Blynk - Sincronizzazione dello stato</a> 
...
.. |link_esp32_extension_board| raw:: html
    ...
    <a href="https://www.sunfounder.com/products/sunfounder-esp32-camera-pro-kit?_pos=3&_sid=3d56bf6ea&_ss=r" target="_blank">ACQUISTA</a>

.. |link_esp32_kit| raw:: html

    <a href="https://www.sunfounder.com/collections/esp32-1/products/sunfounder-esp32-ultimate-starter-kit-with-esp32-camera-extension-board-battery" target="_blank">Link per l'acquisto di ESP32 Starter Kit</a>
...
.. |link_esp32_wroom_32e_buy| raw:: html
    ...
    <a href="https://www.sunfounder.com/products/esp-wroom-32-esp32-esp-32s-development-board" target="_blank">ACQUISTA</a>    
